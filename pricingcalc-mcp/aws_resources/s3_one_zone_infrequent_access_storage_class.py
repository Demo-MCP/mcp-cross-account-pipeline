...
@dataclass
class S3OneZoneInfrequentAccessStorageClass:
    """
    Python equivalent of Infracost S3OneZoneInfrequentAccessStorageClass resource.
...
USAGE_SCHEMAS = {
  "S3OneZoneInfrequentAccessStorageClass": [
    {
      "key": "storage_gb",
      "type": "Optional[float]",
      "default_value": 0
